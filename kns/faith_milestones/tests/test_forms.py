...
from kns.faith_milestones.forms import (
    GroupFaithMilestonesForm,
    ProfileFaithMilestonesForm,
)
...
class TestGroupFaithMilestonesForm(TestCase):
    def setUp(self):
        """
        Create a user, mock settings, and create some faith milestones.
        """
    ...
    def test_valid_form(self):
        ...
        form = GroupFaithMilestonesForm(data=form_data)
